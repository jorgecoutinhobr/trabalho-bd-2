...
-- indices consulta 3
CREATE INDEX idx_jogos_usuario_id_usuario_id_jogo ON jogos_usuario (id_usuario, id_jogo);
CREATE INDEX idx_jogos_usuario_id_jogo_id_usuario ON jogos_usuario (id_jogo, id_usuario);
--
